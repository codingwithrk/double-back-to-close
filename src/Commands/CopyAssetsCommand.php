...
namespace Codingwithrk\DoubleBackToClose\Commands;

use Native\Mobile\Plugins\Commands\NativePluginHookCommand;

/**
 * Copy assets hook command for DoubleBackToClose plugin.
 *
...
{
    protected $signature = 'nativephp:double-back-to-close:copy-assets';

    protected $description = 'Copy assets for DoubleBackToClose plugin';
    ...
    protected function copyAndroidAssets(): void
    {
        ...
        $this->info('Android assets copied for DoubleBackToClose');
    }
    ...
    protected function copyIosAssets(): void
    {
        ...
        $this->info('iOS assets copied for DoubleBackToClose');
    }
}